...
while ($i <= $att_loop) {
    ...
    if ($full_date === $compare) {
        ...
        $col6 = ($resultArr[$j]->is_same ? "TIDAK LENGKAP" : ($resultArr[$j]->is_late ? "TERLAMBAT" : ""));
    ...
    $objPHPExcel->getActiveSheet()->getStyle($cell.":".incCell($cell, 'C', 5))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
